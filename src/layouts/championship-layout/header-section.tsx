...
const HeaderRoot = styled(AppBar, {
  ...
  // Estilos base para os pseudo-elementos (transição, posição, etc)
  ...
  // Pseudo-elemento de fundo que sempre ficará visível com primary.dark
  const bgStyles: CSSObject = {
    ...
    // Sempre visível, sem depender do scroll:
    opacity: 1,
    visibility: "visible",
  };

  // Mantém a sombra (caso necessária) e a deixa visível quando houver scroll;
